...
var require = meteorInstall({"node_modules":{"meteor":{"aldeed:autoform":{"utility.js":function(require,exports,module){
...
Utility = {
   ...
   */
  docToModifier: function () {
    function docToModifier(doc, options) {
      var modifier = {},
          mDoc,
          flatDoc,
          nulls;
  ...
  getSelectOptions: function () {
    function getSelectOptions(defs, hash) {
   ...
   */
  getFieldDefinition: function (ss, name) {
    var def = ss.getDefinition(name);
    if (!def) return;
   ...
   */
  bubbleEmpty: function () {
    function bubbleEmpty(obj, keepEmptyStrings) {
      if (_.isObject(obj)) {
        _.each(obj, function (val, key) {
          if (_.isArray(val)) {
  ...
  isNullUndefinedOrEmptyString: function () {
    ...
    return isNullUndefinedOrEmptyString;
  }(),
   ...
   */
  isValidNormalizedForcedUtcGlobalDateAndTimeString: function () {
    ...
    return isValidNormalizedForcedUtcGlobalDateAndTimeString;
  }(),
   ...
   */
  isValidNormalizedLocalDateAndTimeString: function () {
    ...
    return isValidNormalizedLocalDateAndTimeString;
  }(),
  ...
  getComponentContext: function () {
    function autoFormGetComponentContext(context, name) {
      var atts,
          defs = {},
    ...
    return autoFormGetComponentContext;
  }(),
  ...
  stringToArray: function () {
    function stringToArray(s, errorMessage) {
      if (typeof s === 'string') {
   ...
   */
  getFormTypeDef: function () {
    function getFormTypeDef(formType) {
...
if (typeof Object.getPrototypeOf !== 'function') {
  if ((0, _typeof2.default)(''.__proto__) === 'object') {
 ...
 */
FormPreserve = function () {
  function formPreserveConstructor(migrationName) {
    var self = this;
    if (!_.isString(migrationName)) throw Error('You must define an unique migration name of type String');
    self.registeredForms = {};
    self.retrievedDocuments = {};

    if (Package.reload) {
      var Reload = Package.reload.Reload;
      self.retrievedDocuments = Reload._migrationData(migrationName) || '{}'; // Currently migration does not seem to support proper storage
  ...
  return formPreserveConstructor;
}();
...
},"autoform-hooks.js":function(require){
...
AutoForm = AutoForm || {}; // formPreserve is used to keep current form data across hot code
...
arrayTracker = new ArrayTracker(); // Used by AutoForm._forceResetFormValues; temporary hack

AutoForm._destroyForm = {}; // reactive templates
...
},"autoform-validation.js":function(){
...
},"autoform-api.js":function(require,exports,module){
...
AutoForm.addHooks = function () {
  function autoFormAddHooks(formIds, hooks, replace) {
...
AutoForm.hooks = function () {
  function autoFormHooks(hooks, replace) {
    _.each(hooks, function (hooksObj, formId) {
      AutoForm.addHooks(formId, hooksObj, replace);
    });
  }

  return autoFormHooks;
}();
/**
...
AutoForm._forceResetFormValues = function () {
  function autoFormForceResetFormValues(formId) {
  ...
  return autoFormForceResetFormValues;
}();
/**
...
AutoForm.setDefaultTemplate = function () {
  function autoFormSetDefaultTemplate(template) {
    globalDefaultTemplate = template;
    deps.defaultTemplate.changed();
  }

  return autoFormSetDefaultTemplate;
}();
/**
...
AutoForm.getDefaultTemplate = function () {
  function autoFormGetDefaultTemplate() {
    deps.defaultTemplate.depend();
    return globalDefaultTemplate;
  }

  return autoFormGetDefaultTemplate;
}();
/**
...
AutoForm.setDefaultTemplateForType = function () {
  function autoFormSetDefaultTemplateForType(type, template) {
  ...
  return autoFormSetDefaultTemplateForType;
}();
/**
...
AutoForm.getDefaultTemplateForType = function () {
  function autoFormGetDefaultTemplateForType(type) {
    if (!deps.defaultTypeTemplates[type]) {
      deps.defaultTypeTemplates[type] = new Tracker.Dependency();
    }
  ...
  return autoFormGetDefaultTemplateForType;
}();
/**
...
AutoForm.getTemplateName = function () {
  function autoFormGetTemplateName(templateType, templateName, fieldName, skipExistsCheck) {
    ...
    var templateFromAncestor = AutoForm.findAttribute('template-' + templateType);
    ...
    var defaultTemplateForType = AutoForm.getDefaultTemplateForType(templateType);
    ...
    var defaultTemplate = AutoForm.getDefaultTemplate();
  ...
  return autoFormGetTemplateName;
}();
/**
...
AutoForm.getFormValues = function () {
  function autoFormGetFormValues(formId, template, ss, getModifier) {
    var insertDoc, updateDoc, transforms;
    template = template || AutoForm.templateInstanceForForm(formId);

    if (!template || !template.view || // We check for domrange later in this function
    ...
    var form = AutoForm.getCurrentDataForForm(formId); // By default, we do not keep empty strings
    ...
    if (template.view._domrange) {
      ...
      doc = getFlatDocOfFieldValues(getAllFieldsInForm(template), ss); // Expand the flat document

      doc = AutoForm.Utility.expandObj(doc); // When all fields that comprise a sub-object are empty, we should unset
    ...
    if (getModifier !== true) {
      ...
      insertDoc = AutoForm.Utility.cleanNulls(doc, false, keepEmptyStrings); // As array items are removed, gaps can appear in the numbering,
      ...
      _.each(transforms, function () {
        function formValuesTransform(transform) {
...
AutoForm.getFieldValue = function () {
  function autoFormGetFieldValue(fieldName, formId) {
...
AutoForm.getInputTypeTemplateNameForElement = function () {
  function autoFormGetInputTypeTemplateNameForElement(element) {
    // get the enclosing view
    var view = Blaze.getView(element); // if the enclosing view is not a template, perhaps because
    // the template contains a block helper like if, with, each,
    // then look up the view chain until we arrive at a template

    while (view && view.name.indexOf('Template.') !== 0 && view.name.indexOf('BlazeComponent.') !== 0) {
      view = view.originalParentView || view.parentView;
    }

    if (!view) return; // View names have "Template." or "BlazeComponent." at the beginning so we slice that off.

    return view.name.slice(view.name.indexOf('.') + 1);
  }

  return autoFormGetInputTypeTemplateNameForElement;
}();
/**
...
AutoForm.getInputValue = function () {
  function autoFormGetInputValue(element, ss) {
    ...
    field = $(element); // Get the field/schema key name

    fieldName = field.attr('data-schema-key'); // If we have a schema, we can autoconvert to the correct data type

    if (ss) fieldType = ss.getQuickTypeForKey(fieldName); // Get the name of the input type template used to render the input element

    inputTypeTemplate = AutoForm.getInputTypeTemplateNameForElement(element); // Slice off the potential theme template, after the last underscore.
    ...
    typeDef = _.where(AutoForm._inputTypeDefinitions, {
      template: inputTypeTemplate
    })[0]; // If field has a "data-null-value" attribute, value should always be null
...
AutoForm.addInputType = function () {
  function afAddInputType(name, definition) {
    var obj = {};
    obj[name] = definition;
...
AutoForm.addFormType = function () {
  function afAddFormType(name, definition) {
    var obj = {};
    obj[name] = definition;
...
AutoForm.validateField = function () {
  function autoFormValidateField(formId, fieldName, skipEmpty) {
    return validateField(fieldName, formId, skipEmpty, false);
  }

  return autoFormValidateField;
}();
/**
...
AutoForm.validateForm = function () {
  function autoFormValidateForm(formId) {
    var form = AutoForm.getCurrentDataForForm(formId);
    var formDoc,
        formType = form.type;
    var ftd = Utility.getFormTypeDef(formType); // Gather all form values
...
AutoForm.getValidationContext = function () {
  function autoFormGetValidationContext(formId) {
    var form = AutoForm.getCurrentDataForForm(formId);
    var ss = form._resolvedSchema;
    if (!ss) return; // formId may not be passed in, but we MUST pass it into namedContext to get back proper context

    formId = formId || form.id;
    return ss.namedContext(formId);
  }

  return autoFormGetValidationContext;
}();
/**
...
AutoForm.findAttribute = function () {
  function autoFormFindAttribute(attrName) {
...
AutoForm.findAttributesWithPrefix = function () {
  function autoFormFindAttributesWithPrefix(prefix) {
    var result = {},
        view,
        viewData,
        searchObj;
  ...
  return autoFormFindAttributesWithPrefix;
}();
/**
...
AutoForm.debug = function () {
  function autoFormDebug() {
...
AutoForm.getInputType = function () {
  function getInputType(atts) {
    var type;
    atts = AutoForm.Utility.getComponentContext(atts, 'afFieldInput').atts; // If a `type` attribute is specified, we just use that

    if (atts.type) return atts.type; // Get schema definition, using the item definition for array fields

    var ss = AutoForm.getFormSchema();
    var schemaType = ss && ss.getQuickTypeForKey(atts.name);
    if (!schemaType) return 'text';
    var expectsArray = schemaType.endsWith('Array'); // Based on the `type` attribute, the `type` from the schema, and/or
...
AutoForm.getSchemaForField = function () {
  function autoFormGetSchemaForField(name) {
    var ss = AutoForm.getFormSchema();
    if (!ss) return;
    return Utility.getFieldDefinition(ss, name);
  }

  return autoFormGetSchemaForField;
}();
/**
...
AutoForm._getOptionsForField = function () {
  function autoFormGetOptionsForField(name) {
    var ss, def, saf, allowedValues;
    ss = AutoForm.getFormSchema();
    if (!ss) return;
    def = AutoForm.Utility.getFieldDefinition(ss, name);
    if (!def) return; // If options in schema, use those
  ...
  return autoFormGetOptionsForField;
}();
/**
...
AutoForm.getLabelForField = function () {
  function autoFormGetLabelForField(name) {
    return AutoForm.getFormSchema().label(name);
  }

  return autoFormGetLabelForField;
}();
/**
...
AutoForm.selectFirstInvalidField = function () {
  ...
  return selectFirstInvalidField;
}();

AutoForm.addStickyValidationError = function () {
  function addStickyValidationError(formId, key, type, value) {
    var template = AutoForm.templateInstanceForForm(formId);
    if (!template) return; // Add error
  ...
  return addStickyValidationError;
}();

AutoForm.removeStickyValidationError = function () {
  function removeStickyValidationError(formId, key) {
    var template = AutoForm.templateInstanceForForm(formId);
    if (!template) return; // Remove errors

    delete template._stickyErrors[key]; // Revalidate that field

    validateField(key, formId, false, false);
  }

  return removeStickyValidationError;
}();
/**
...
AutoForm._validateFormDoc = function () {
  function validateFormDoc(doc, isModifier, formId, ss, form, key) {
    ...
    var vc = ss.namedContext(formId); // Validate
...
setDefaults = function () {
  function setDefaults(data) {
    if (!data) data = {}; // default form type is "normal"
...
AutoForm.addFormType('insert', {
  onSubmit: function () {
    ...
    var collectionHasSchema = typeof collection.simpleSchema === "function" && collection.simpleSchema(this.insertDoc) != null; // Run "before.insert" hooks
...
AutoForm.addFormType('method', {
  ...
  validateForm: function () {
    ...
    ss = this.useCollectionSchema && collection ? collection.simpleSchema() : ss; // Validate
...
AutoForm.addFormType('readonly', {
  onSubmit: function () {
    ...
    this.event.preventDefault(); // Nothing else
  },
  validateForm: function () {
    // Always valid
    return true;
...
}},"inputTypes":{"value-converters.js":function(){
...
}},"boolean-radios":{"template.boolean-radios.js":function(){
...
}},"boolean-select":{"template.boolean-select.js":function(){
...
AutoForm.addInputType("boolean-select", {
  ...
  contextAdjust: function (context) {
    var atts = _.omit(context.atts, 'trueLabel', 'falseLabel', 'nullLabel', 'firstOption'); // build items list
...
}},"contenteditable":{"template.contenteditable.js":function(){
...
}},"file":{"template.file.js":function(){
...
}},"hidden":{"template.hidden.js":function(){
...
}},"image":{"template.image.js":function(){
...
AutoForm.addInputType("select-checkbox", {
  ...
  contextAdjust: function (context) {
    var itemAtts = _.omit(context.atts); // build items list


    context.items = []; // Add all defined options
...
}},"select-multiple":{"template.select-multiple.js":function(){
...
}}},"components":{"autoForm":{"template.autoForm.js":function(){
...
},"autoForm.js":function(require,exports,module){
...
}},"quickForm":{"template.quickForm.js":function(){
  ...
  innerContext: function () {
    function quickFormContext() {
      ...
      if (fieldList) {
        ...
        var fullSchema = simpleSchema.mergedSchema();
...
Template.afArrayField.helpers({
  ...
  innerContext: function () {
    function afArrayFieldContext() {
      ...
      var ss = AutoForm.getFormSchema();
      var formId = AutoForm.getFormId(); // Init the array tracking for this field
    ...
    return afArrayFieldContext;
  }()
});
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

}},"afEachArrayItem":{"template.afEachArrayItem.js":function(){
...
Template.afEachArrayItem.helpers({
  innerContext: function () {
    function afEachArrayItemContext() {
    ...
    return afEachArrayItemContext;
  }()
});
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

}},"afFieldInput":{"template.afFieldInput.js":function(){
...
}},"afQuickField":{"template.afQuickField.js":function(){
...
},"afQuickField.js":function(require){
...
}},"afQuickFields":{"template.afQuickFields.js":function(){
...
Template.afQuickFields.helpers({
  quickFieldAtts: function () {
    function afQuickFieldsQuickFieldAtts() {
      var afQuickFieldsComponentAtts,
          defaultOptions,
          atts = {}; // Get the attributes that were on the afQuickFields component

      afQuickFieldsComponentAtts = Template.parentData(1); // It's possible to call {{> afQuickFields}} with no attributes, in which case we
    ...
    return afQuickFieldsQuickFieldAtts;
  }()
});
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

}}},"autoform-events.js":function(){
...
},"templates":{"bootstrap3":{"bootstrap3.js":function(){
 ...
 */
Template.registerHelper('attsPlusFormControlClass', function () {
  function attsPlusFormControlClass() {
  ...
  return attsPlusFormControlClass;
}());
Template.registerHelper('attsPlusBtnClass', function () {
  function attsPlusBtnClass() {
    var atts = _.clone(this.atts); // Add bootstrap class
...
Template.quickForm_bootstrap3.helpers({
  ...
  submitButtonAtts: function () {
    function bsQuickFormSubmitButtonAtts() {
    ...
    return bsQuickFormSubmitButtonAtts;
  }()
});
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                     //
// packages/aldeed_autoform/templates/bootstrap3/components/afArrayField/afArrayField.js                               //
//                                                                                                                     //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                       //
...
}}},"inputTypes":{"boolean-checkbox":{"template.boolean-checkbox.js":function(){
...
}}}},"bootstrap3-horizontal":{"components":{"quickForm":{"template.quickForm.js":function(){
...
Template['quickForm_bootstrap3-horizontal'].helpers({
  ...
  qfAutoFormContext: function () {
    ...
    ctx = AutoForm.Utility.addClass(ctx, 'form-horizontal'); // input-col-class and label-class attributes are unique to this template so they will
...
Template["afObjectField_bootstrap3-horizontal"].helpers({
  ...
  quickFieldsAtts: function () {
    var atts = _.pick(this, 'name', 'id-prefix'); // We want to default to using bootstrap3 template below this point
...
}}}},"bootstrap3-inline":{"template.bootstrap3-inline.js":function(){
...
}},"plain":{"components":{"quickForm":{"template.quickForm.js":function(){
...
Template.quickForm_plain.helpers({
  ...
  submitButtonAtts: function () {
    function plQuickFormSubmitButtonAtts() {
      var qfAtts = this.atts;
      var atts = {};
    ...
    return plQuickFormSubmitButtonAtts;
  }()
});
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
}}}},"plain-fieldset":{"template.plain-fieldset.js":function(){
...
Template['quickForm_plain-fieldset'].helpers({
  ...
  submitButtonAtts: function () {
    function plfsQuickFormSubmitButtonAtts() {
      var qfAtts = this.atts;
      var atts = {};
    ...
    return plfsQuickFormSubmitButtonAtts;
  }()
});
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
require("/node_modules/meteor/aldeed:autoform/utility.js");
require("/node_modules/meteor/aldeed:autoform/form-preserve.js");
require("/node_modules/meteor/aldeed:autoform/autoform-hooks.js");
require("/node_modules/meteor/aldeed:autoform/autoform-formdata.js");
require("/node_modules/meteor/aldeed:autoform/autoform-arrays.js");
require("/node_modules/meteor/aldeed:autoform/autoform.js");
require("/node_modules/meteor/aldeed:autoform/autoform-helpers.js");
require("/node_modules/meteor/aldeed:autoform/autoform-validation.js");
require("/node_modules/meteor/aldeed:autoform/autoform-inputs.js");
require("/node_modules/meteor/aldeed:autoform/autoform-api.js");
require("/node_modules/meteor/aldeed:autoform/formTypes/insert.js");
require("/node_modules/meteor/aldeed:autoform/formTypes/update.js");
require("/node_modules/meteor/aldeed:autoform/formTypes/update-pushArray.js");
require("/node_modules/meteor/aldeed:autoform/formTypes/method.js");
require("/node_modules/meteor/aldeed:autoform/formTypes/method-update.js");
require("/node_modules/meteor/aldeed:autoform/formTypes/normal.js");
require("/node_modules/meteor/aldeed:autoform/formTypes/readonly.js");
require("/node_modules/meteor/aldeed:autoform/formTypes/disabled.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/value-converters.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/boolean-checkbox/template.boolean-checkbox.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/boolean-checkbox/boolean-checkbox.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/boolean-radios/template.boolean-radios.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/boolean-radios/boolean-radios.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/boolean-select/template.boolean-select.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/boolean-select/boolean-select.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/button/template.button.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/button/button.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/color/template.color.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/color/color.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/contenteditable/template.contenteditable.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/contenteditable/contenteditable.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/date/template.date.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/date/date.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/datetime/template.datetime.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/datetime/datetime.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/datetime-local/template.datetime-local.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/datetime-local/datetime-local.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/email/template.email.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/email/email.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/file/template.file.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/file/file.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/hidden/template.hidden.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/hidden/hidden.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/image/template.image.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/image/image.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/month/template.month.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/month/month.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/number/template.number.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/number/number.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/password/template.password.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/password/password.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/radio/template.radio.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/radio/radio.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/range/template.range.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/range/range.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/reset/template.reset.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/reset/reset.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/search/template.search.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/search/search.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/select/template.select.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/select/select.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/select-checkbox/template.select-checkbox.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/select-checkbox/select-checkbox.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/select-checkbox-inline/template.select-checkbox-inline.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/select-checkbox-inline/select-checkbox-inline.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/select-multiple/template.select-multiple.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/select-multiple/select-multiple.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/select-radio/template.select-radio.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/select-radio/select-radio.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/select-radio-inline/template.select-radio-inline.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/select-radio-inline/select-radio-inline.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/submit/template.submit.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/submit/submit.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/tel/template.tel.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/tel/tel.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/text/template.text.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/text/text.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/textarea/template.textarea.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/textarea/textarea.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/time/template.time.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/time/time.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/url/template.url.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/url/url.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/week/template.week.js");
require("/node_modules/meteor/aldeed:autoform/inputTypes/week/week.js");
require("/node_modules/meteor/aldeed:autoform/components/autoForm/template.autoForm.js");
require("/node_modules/meteor/aldeed:autoform/components/autoForm/autoForm.js");
require("/node_modules/meteor/aldeed:autoform/components/quickForm/template.quickForm.js");
require("/node_modules/meteor/aldeed:autoform/components/quickForm/quickForm.js");
require("/node_modules/meteor/aldeed:autoform/components/afArrayField/template.afArrayField.js");
require("/node_modules/meteor/aldeed:autoform/components/afArrayField/afArrayField.js");
require("/node_modules/meteor/aldeed:autoform/components/afEachArrayItem/template.afEachArrayItem.js");
require("/node_modules/meteor/aldeed:autoform/components/afEachArrayItem/afEachArrayItem.js");
require("/node_modules/meteor/aldeed:autoform/components/afFieldInput/template.afFieldInput.js");
require("/node_modules/meteor/aldeed:autoform/components/afFieldInput/afFieldInput.js");
require("/node_modules/meteor/aldeed:autoform/components/afFormGroup/template.afFormGroup.js");
require("/node_modules/meteor/aldeed:autoform/components/afFormGroup/afFormGroup.js");
require("/node_modules/meteor/aldeed:autoform/components/afObjectField/template.afObjectField.js");
require("/node_modules/meteor/aldeed:autoform/components/afObjectField/afObjectField.js");
require("/node_modules/meteor/aldeed:autoform/components/afQuickField/template.afQuickField.js");
require("/node_modules/meteor/aldeed:autoform/components/afQuickField/afQuickField.js");
require("/node_modules/meteor/aldeed:autoform/components/afQuickFields/template.afQuickFields.js");
require("/node_modules/meteor/aldeed:autoform/components/afQuickFields/afQuickFields.js");
require("/node_modules/meteor/aldeed:autoform/autoform-events.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/bootstrap3.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/components/quickForm/template.quickForm.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/components/quickForm/quickForm.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/components/afArrayField/template.afArrayField.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/components/afArrayField/afArrayField.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/components/afFormGroup/template.afFormGroup.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/components/afFormGroup/afFormGroup.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/components/afObjectField/template.afObjectField.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/components/afObjectField/afObjectField.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/inputTypes/boolean-checkbox/template.boolean-checkbox.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/inputTypes/boolean-radios/template.boolean-radios.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/inputTypes/boolean-radios/boolean-radios.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/inputTypes/boolean-select/template.boolean-select.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/inputTypes/button/template.button.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/inputTypes/color/template.color.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/inputTypes/date/template.date.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/inputTypes/datetime/template.datetime.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/inputTypes/datetime-local/template.datetime-local.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/inputTypes/email/template.email.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/inputTypes/month/template.month.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/inputTypes/number/template.number.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/inputTypes/password/template.password.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/inputTypes/radio/template.radio.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/inputTypes/radio/radio.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/inputTypes/range/template.range.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/inputTypes/reset/template.reset.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/inputTypes/search/template.search.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/inputTypes/select/template.select.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/inputTypes/select-checkbox/template.select-checkbox.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/inputTypes/select-checkbox/select-checkbox.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/inputTypes/select-checkbox-inline/template.select-checkbox-inline.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/inputTypes/select-checkbox-inline/select-checkbox-inline.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/inputTypes/select-multiple/template.select-multiple.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/inputTypes/select-radio/template.select-radio.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/inputTypes/select-radio/select-radio.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/inputTypes/select-radio-inline/template.select-radio-inline.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/inputTypes/select-radio-inline/select-radio-inline.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/inputTypes/submit/template.submit.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/inputTypes/tel/template.tel.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/inputTypes/text/template.text.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/inputTypes/textarea/template.textarea.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/inputTypes/time/template.time.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/inputTypes/url/template.url.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3/inputTypes/week/template.week.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3-horizontal/components/quickForm/template.quickForm.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3-horizontal/components/quickForm/quickForm.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3-horizontal/components/afArrayField/template.afArrayField.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3-horizontal/components/afArrayField/afArrayField.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3-horizontal/components/afFormGroup/template.afFormGroup.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3-horizontal/components/afFormGroup/afFormGroup.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3-horizontal/components/afObjectField/template.afObjectField.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3-horizontal/components/afObjectField/afObjectField.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3-horizontal/inputTypes/boolean-checkbox/template.boolean-checkbox.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3-horizontal/inputTypes/boolean-checkbox/boolean-checkbox.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3-inline/template.bootstrap3-inline.js");
require("/node_modules/meteor/aldeed:autoform/templates/bootstrap3-inline/bootstrap3-inline.js");
require("/node_modules/meteor/aldeed:autoform/templates/plain/components/quickForm/template.quickForm.js");
require("/node_modules/meteor/aldeed:autoform/templates/plain/components/quickForm/quickForm.js");
require("/node_modules/meteor/aldeed:autoform/templates/plain/components/afArrayField/template.afArrayField.js");
require("/node_modules/meteor/aldeed:autoform/templates/plain/components/afFormGroup/template.afFormGroup.js");
require("/node_modules/meteor/aldeed:autoform/templates/plain/components/afObjectField/template.afObjectField.js");
require("/node_modules/meteor/aldeed:autoform/templates/plain/components/afObjectField/afObjectField.js");
require("/node_modules/meteor/aldeed:autoform/templates/plain-fieldset/template.plain-fieldset.js");
require("/node_modules/meteor/aldeed:autoform/templates/plain-fieldset/plain-fieldset.js");
