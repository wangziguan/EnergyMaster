...
adminCollections = function () {
  ...
  if (typeof AdminConfig !== 'undefined' && _typeof(AdminConfig.collections) === 'object') {
...
UI.registerHelper('admin_collection_items', function () {
  ...
  _.each(AdminDashboard.collectionItems, function (fn) {
    var item;
...
UI.registerHelper('admin_omit_fields', function () {
  ...
  if (typeof AdminConfig.autoForm !== 'undefined' && _typeof(AdminConfig.autoForm.omitFields) === 'object') {
    global = AdminConfig.autoForm.omitFields;
  }

  if (!Session.equals('admin_collection_name', 'Users') && typeof AdminConfig !== 'undefined' && _typeof(AdminConfig.collections[Session.get('admin_collection_name')].omitFields) === 'object') {
    collection = AdminConfig.collections[Session.get('admin_collection_name')].omitFields;
  }

  if (_typeof(global) === 'object' && _typeof(collection) === 'object') {
...
UI.registerHelper('adminGetUserSchema', function () {
  ...
  } else if (_typeof(Meteor.users._c2) === 'object') {
